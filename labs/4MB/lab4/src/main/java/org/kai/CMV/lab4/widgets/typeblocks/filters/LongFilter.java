...
/**
 * Фильтр больших числовых значений
 */
public class LongFilter extends AbstractFilter {
	 ...
	 *            Тип
	 */
	public LongFilter(Composite aComposite, int aStyle, Type aType) {
		...
		xLabel.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false, false));
